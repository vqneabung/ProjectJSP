...
<html>
    ...
    <body>
        ...
        <c:forEach items="${requestScope.userMealList}" var="userMeal">
            ...
            <p><a href="/ProjectJSP/InsertUserMealDetailServlet?userMealID=${userMeal.userMealID}&insert">Insert</a></p>
            <p><a href="/ProjectJSP/RemoveUserMealDetailServlet?userMealID=${userMeal.userMealID}">Remove</a></p>
            <table border = "1">
                <tr>
                    <th>Product Name</th>
                    <th>Dish</th>
