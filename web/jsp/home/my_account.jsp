<%-- 
    Document   : my_account
    Created on : Jun 6, 2024, 8:56:48 PM
    Author     : VQN
--%>
                        ...
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    <a href="/ProjectJSP/EditProfileServlet?userID=${sessionScope.User.userID}" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-primary ms-1">Edit</a>
                                </div>
                                <div>
                                    <p>${requestScope.update_status}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">${sessionScope.User.phone}</p>
                                    </div>
                                </div>
                                <hr>
