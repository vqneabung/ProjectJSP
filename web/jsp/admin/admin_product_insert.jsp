...
<html>
    ...
    <body>
        ...
        <form action="/ProjectJSP/InsertProductServlet" enctype="multipart/form-data" method="post" >
            ...
            <textarea id="text_describe" name="insert_describe" placeholder="Write Describe"></textarea>
            <div >
                Chọn ảnh thức ăn <input type="file" name="insert_image" value=""  accept="image/*" multiple/>
