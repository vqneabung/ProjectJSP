                            ...
                            <c:forEach var="user" items="${sessionScope.users}">
                                <c:if test="${user.status == 0}">
                                    <tr style="font-size: medium">
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="${pageContext.request.contextPath}/RemoveUserServlet?userID=${user.userID}">Xóa</a>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#userListTable').DataTable({
                ...
                "info": false,
                "columnDefs": [
                    {"orderable": false, "targets": [8,9,10]} // Vô hiệu hóa sắp xếp cho cột "Hành động" và "Lịch sử hoạt động"
                ],
                "language": {
