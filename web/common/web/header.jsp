...
<header class="p-3 bg-dark text-white sticky-top">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/ProjectJSP/StartServlet" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
            ...
            <div style="margin-left: 1rem">
                <a type="button" class="btn btn-primary" id="cart" href="/ProjectJSP/StartServlet?action=cart"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
